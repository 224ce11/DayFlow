        ...
        <div class="container nav-container"
            ...
            <div class="nav-actions">
                ...
                <a href="profile.php" class="user-profile-link"
                    style="display: flex; align-items: center; gap: 12px; text-decoration: none; padding: 4px 8px; border-radius: 24px; transition: background 0.2s;">
                ...
                <a href="Login.php" class="btn btn-sm btn-icon-only" title="Logout"
            ...
            <div class="dash-container" style="padding: 32px; max-width: 1400px; margin: 0 auto;">
                ...
                <div id="module-recruitment" class="module-section">
                    <div class="card">
                        ...
                        <p style="color: var(--text-light); text-align: center; padding: 40px;">No open positions
                            available.</p>
                    </div>
                </div>
