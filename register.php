    ...
    <div class="login-wrapper">
        ...
        <div class="login-container">
            <div class="login-header">
                <a href="<?php echo $is_admin ? 'admin_dashboard.php' : 'index.php'; ?>" class="logo-center"><i
                        class="fa fa-layer-group"></i> Dayflow</a>
                <h2><?php echo $page_title; ?></h2>
                <p><?php echo $is_admin ? "Add a new member to your team." : "Register your company to start managing your team."; ?>
                </p>
            </div>

            <?php if (!empty($message)): ?>
                <div class="error-message"
                    style="<?php echo ($messageType == 'success') ? 'background:#ecfdf5; color:#047857; border-color:#6ee7b7;' : ''; ?>">
            ...
            <form action="register.php" method="POST" class="login-form">
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="text" id="company_name" name="company_name" placeholder="Acme Corp" required <?php if ($is_admin)
                            echo 'value="Internal"'; ?>>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="password" id="confirm_password" name="confirm_password" placeholder="••••••••"
                            required>
                        <i class="fa fa-eye toggle-password" onclick="togglePassword(this, 'confirm_password')"></i>
                    </div>
                </div>
